                ...
                securityHeadersBehavior: {
                    contentSecurityPolicy: {
                        contentSecurityPolicy: [
                            ...
                            "script-src 'self' 'wasm-unsafe-eval' 'sha256-nS5kAwbc34VjnQITJF9BzMwoyqwPHjr8AZAuEG6I1vk=' 'sha256-YdtuMUGC4DsCNinKCVIP7Fy59FClVqlNxznDDoYlAm4=' 'sha256-ODJlYxxRk/rdZIzSqQXGmY0ShmSVIb2SP/HVqQoVqZI='",
                        ].join("; "),
                        override: true,
                    },
