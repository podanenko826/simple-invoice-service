    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-background flex flex-col">
                ...
                {/* Invoice Counter - Show loading skeleton or count */}
                {isLoadingCount ? (
                    <div className="mb-3">
                        <span className="text-sm text-muted-foreground/60">
                            <span className="inline-block h-4 w-8 bg-muted-foreground/20 rounded animate-pulse"></span> invoices generated by freelancers and small businesses
                        </span>
                    </div>
                ) : invoiceCount !== null ? (
                    <div className="mb-3">
                        <span className="text-sm text-muted-foreground/60">
                            <span className="font-semibold text-foreground">{invoiceCount}+</span> {invoiceCount === 1 ? "invoice" : "invoices"} generated by freelancers and small businesses
                        </span>
                    </div>
                ) : null}
