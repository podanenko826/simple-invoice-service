...
import type { TokensFromRefresh } from "./model.js";
import { retrieveTokens, type TokensFromStorage } from "./storage.js";
import { initiateAuth } from "./cognito-api.js";
import { setTimeoutWallClock } from "./utils.js";
...
async function _refreshTokens({
    ...
    try {
        ...
        if (!refreshToken || !username) {
            throw new Error(
                "Cannot refresh without refresh token and username",
            );
        }
